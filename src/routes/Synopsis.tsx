...
import { fetchSynopsis } from '../lib/cases'
...
export function Synopsis() {
  ...
  useEffect(() => {
    ...
    fetchSynopsis(caseId)
      .then(setText)
      .catch((err) => setError(err instanceof Error ? err.message : 'Failed to generate synopsis'))
  }, [caseId])
  ...
  function handleDownload() {
    ...
    link.href = url
    link.download = `synopsis-${caseId}.txt`
    link.click()
  ...
  return (
    <section className="synopsis">
      ...
      {text == null && !error && <p>Generating synopsis…</p>}
